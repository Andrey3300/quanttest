...
function getGenerator(symbol) {
    if (!generators.has(symbol)) {
        ...
        const config = {
            ...
            'USD_IDR_OTC': { basePrice: 0.000063, volatility: 0.0035, drift: 0.0002 },
            ...
            'AUD_JPY_OTC': { basePrice: 96.850, volatility: 0.0033, drift: -0.0001 },
            'EUR_GBP_OTC': { basePrice: 0.8580, volatility: 0.0030, drift: 0.0001 },
            'EUR_HUF_OTC': { basePrice: 393.50, volatility: 0.0035, drift: -0.0002 },
            'EUR_TRY_OTC': { basePrice: 37.250, volatility: 0.0043, drift: 0.0001 },
            'USD_JPY_OTC': { basePrice: 149.850, volatility: 0.0032, drift: 0.0002 },
            'USD_CHF_OTC': { basePrice: 0.8690, volatility: 0.0030, drift: 0.0001 },
            'AUD_CHF': { basePrice: 0.5820, volatility: 0.0031, drift: -0.0001 },
            'CHF_JPY': { basePrice: 172.450, volatility: 0.0033, drift: 0.0001 },
            ...
            'EUR_JPY': { basePrice: 162.650, volatility: 0.0031, drift: 0.0001 },
            ...
            'BTC_OTC': { basePrice: 68750, volatility: 0.0068, drift: 0.0001 },
            'BTC_ETF_OTC': { basePrice: 68600, volatility: 0.0062, drift: -0.0001 },
            'ETH_OTC': { basePrice: 3450, volatility: 0.0072, drift: 0.0003 },
            'BNB_OTC': { basePrice: 585, volatility: 0.0075, drift: 0.0002 },
