...
// ПРОБЛЕМА: Генераторы создавались, но никогда не удалялись, утечка памяти
// РЕШЕНИЕ: Каждые 5 минут удаляем генераторы без подписчиков
// ЭФФЕКТ: Предотвращение утечек памяти, оптимизация ресурсов
